...
async function sendToBackend(message){
  ...
  try{
    ...
    // The backend decides whether this is a fresh loan request that needs
    // the structured slip — not keyword-guessing here. This is what stops
    // the slip from re-popping on every loan-related message once an
